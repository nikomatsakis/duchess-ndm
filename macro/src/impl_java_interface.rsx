...
///     fn read(&self, cb: &java::nio::CharBuffer) -> duchess::Result<i32> {
...
///         fn do_jni(jvm: &mut Jvm<'_>) -> duchess::LocalResult<'_, > {
///             // Code to
        ...
        Ok(quote!(
                ...
                #where_clause
            {
                ...
                fn do_jni<'jvm>(
                    ...
                    let env = jvm.env();
                    let obj: duchess::LocalResult<'_, ::core::option::Option<duchess::Local<#interface_ty>>> = unsafe {
